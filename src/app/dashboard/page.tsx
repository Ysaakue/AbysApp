  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <StatCard label="Customers" value={customers} href="/dashboard/customers" />
        <StatCard label="Service Orders" value={orders} href="/dashboard/orders" />
        <StatCard label="Parts" value={parts} href="/dashboard/parts" />
      </div>

      <div>
        <h2 className="text-lg font-medium text-gray-700 mb-3">Recent Orders</h2>
...
function StatCard({ label, value, href }: { label: string; value: number; href: string }) {
  return (
    <Link href={href} className="bg-white rounded-lg shadow p-5 hover:shadow-md transition-shadow block">
